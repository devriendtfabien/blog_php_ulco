...
<div class="container">
    <div class="row">
        ...
        <div class="alert alert-<?= $color_notification?> alert-dismissible fade show" role="alert">
            ...
            <a href="../../../AppData/Local/Temp/Issues 65.url"></a>
        ...
        if(isset($_GET['recherche'])){
            ...
            $nb_article = nb_total_article_recherche($_GET['recherche'], $bdd);
        ...
        <div class="col-lg-12 text-center">
            ...
            <form action="article.php" method="get" enctype="multipart/form-data" id="form_article">
                ...
                <div class="form-group">
                    <label for="titre" class="col-form-label"></label>
                    <input type="text" class="form-control" id="recherche" name="titre" placeholder="Votre Recherche" value="<?=$tab_article['recherche']?>" required>
                </div>
